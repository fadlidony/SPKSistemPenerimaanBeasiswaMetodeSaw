...
<!-- Body -->
		...
		<!-- Page title -->
			...
			$query=mysqli_query($mysqli,"select * from himpunan where id_himpunan='$id_himpunan'");
			...
			if (isset($_POST['ubah'])) {
				...
				$query=mysqli_query($mysqli,"UPDATE himpunan SET id_kriteria='$id_kriteria', namahimpunan='$namahimpunan', nilai='$nilai', keterangan='$keterangan' WHERE id_himpunan='$id_himpunan'") or die(mysqli_error($mysqli));
				if ($query) {
