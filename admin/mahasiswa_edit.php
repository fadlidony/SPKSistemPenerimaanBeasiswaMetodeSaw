...
<?php
$id_mhs = $_GET['id_mhs'];
$query = mysqli_query($mysqli,"select * from calonbeasiswa where id_mhs='$id_mhs'");
...
if (isset($_POST['ubah'])) {
	...
	$query=mysqli_query($mysqli,"UPDATE calonbeasiswa SET nama_mhs='$nama_mhs', jurusan='$jurusan' WHERE id_mhs='$id_mhs'") or die(mysqli_error($mysqli));
	if ($query) {
