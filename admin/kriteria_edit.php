...
$query=mysqli_query($mysqli,"select * from kriteria where id_kriteria='$id_kriteria'");
...
if (isset($_POST['ubah'])) {
	...
	$query=mysqli_query($mysqli,"UPDATE kriteria SET namakriteria='$namakriteria', atribut='$atribut', WHERE id_kriteria='$id_kriteria'") or die(mysqli_error($mysqli));
	if ($query) {
